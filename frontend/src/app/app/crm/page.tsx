...
import { Users, LayoutKanban, CalendarRange } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 flex flex-col h-full">
       <div className="flex border-b border-slate-200 dark:border-slate-800">
           ...
           >
             <LayoutKanban size={18} /> {t('crm_pipeline', { fallback: 'مسار المبيعات' })}
           </button>
           <button 
           ...
           >
             <CalendarRange size={18} /> {t('appointments', { fallback: 'المواعيد' })}
           </button>
       </div>
